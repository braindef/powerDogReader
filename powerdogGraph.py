...
dss.append(ds1)
rra1 = RRA(cf='AVERAGE', xff=0.5, steps=1, rows=144)
rra2 = RRA(cf='AVERAGE', xff=0.5, steps=6, rows=24)
rra3 = RRA(cf='AVERAGE', xff=0.5, steps=24, rows=30)
rra4 = RRA(cf='AVERAGE', xff=0.5, steps=30, rows=12)
rra5 = RRA(cf='AVERAGE', xff=0.5, steps=12, rows=100)
